...
#
Name     : jdk-commons-exec
Version  : 1.3
Release  : 3
URL      : http://www.apache.org/dist/commons/exec/source/commons-exec-1.3-src.tar.gz
Source0  : http://www.apache.org/dist/commons/exec/source/commons-exec-1.3-src.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0
Requires: jdk-commons-exec-data
...
%package data
Summary: data components for the jdk-commons-exec package.
Group: Data

%description data
data components for the jdk-commons-exec package.


%prep
%setup -q -n commons-exec-1.3-src
...
%install
xmvn-install  -R .xmvn-reactor -n apache-commons-exec -d %{buildroot}
